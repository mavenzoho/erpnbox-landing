  ...
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        Build integrations, sync data with external systems, and automate your workflows.
      </p>
      ...
      <div className="bg-brand-50 border border-brand-200 rounded-lg p-6 mb-8">
        ...
        <code className="text-brand-700 bg-white px-3 py-1.5 rounded border border-brand-200 text-sm">
          https://your-instance.erpnbox.com/api/v1
        </code>
      </div>
      ...
      <ol className="list-decimal list-inside space-y-3 text-gray-700 mb-6">
        <li>
          <strong>Create an API key</strong> in Settings &rarr; API Keys (requires ADMIN role)
        </li>
        <li>
          <strong>Copy the key</strong> (shown only once) and store it securely
        </li>
        <li>
...
function AuthSection() {
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        ERPnBox uses API keys for authentication. Each key is scoped to a specific tenant and user.
      </p>
  ...
  -H "Authorization: Bearer erpn_your_key_here"`}</CodeBlock>
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-700">
        <li>
          <strong>Use minimal scopes</strong> &mdash; Only grant the permissions your integration
          needs
        </li>
        <li>
          <strong>Set expiration dates</strong> &mdash; Rotate keys quarterly
        </li>
        <li>
          <strong>Use environment variables</strong> &mdash; Never hardcode keys in source code
        </li>
        <li>
          <strong>Monitor usage</strong> &mdash; Check usage stats for unexpected activity
        </li>
        <li>
          <strong>One key per integration</strong> &mdash; Easy to revoke per integration
        </li>
      </ul>
    </div>
  );
...
function ModulesSection() {
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        Modules are the building blocks of ERPnBox &mdash; they represent data objects like Leads,
        Contacts, Deals, or any custom entity.
      </p>
    ...
    },
    {
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 my-4">
        {[
          ...
          <div
            key={t}
            className="bg-gray-50 border border-gray-200 rounded px-3 py-1.5 text-xs font-mono text-gray-700"
          >
            {t}
          </div>
        ))}
...
function RecordsSection() {
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        Records are the data entries within modules. Full CRUD operations with pagination and
        search.
      </p>
...
function WebhooksSection() {
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        Receive real-time HTTP POST notifications when events occur in ERPnBox.
      </p>
      ...
      <div className="overflow-x-auto my-4">
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">record.created</td>
              <td className="py-2 text-gray-600">A new record is created</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">record.updated</td>
              <td className="py-2 text-gray-600">A record's data changes</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">record.deleted</td>
              <td className="py-2 text-gray-600">A record is deleted</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  "previousData": { "stage": "New" } // only for record.updated
      ...
      <p className="text-gray-600 mb-4">
        ...
        <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">X-ERPnBox-Signature</code>{' '}
        header. <strong>Always verify signatures</strong> to ensure payloads are genuine.
      </p>
    ...
    return hmac.compare_digest(signature, expected)`}</CodeBlock>
      ...
      <div className="overflow-x-auto my-4">
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              <td className="py-2 pr-6 font-mono text-sm">X-ERPnBox-Event</td>
              <td className="py-2 text-gray-600">Event name (e.g., record.created)</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-sm">X-ERPnBox-Signature</td>
              <td className="py-2 text-gray-600">HMAC-SHA256 signature (sha256=...)</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-sm">X-ERPnBox-Delivery-Timestamp</td>
              <td className="py-2 text-gray-600">ISO 8601 timestamp</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="overflow-x-auto my-4">
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              <td className="py-2 pr-6">1st retry</td>
              <td className="py-2 pr-6">10 seconds</td>
              <td className="py-2">~10s</td>
            </tr>
            <tr>
              <td className="py-2 pr-6">2nd retry</td>
              <td className="py-2 pr-6">60 seconds</td>
              <td className="py-2">~70s</td>
            </tr>
            <tr>
              <td className="py-2 pr-6">3rd retry</td>
              <td className="py-2 pr-6">5 minutes</td>
  ...
  "data": [
    {
      ...
      <div className="overflow-x-auto my-4">
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">SUPER_ADMIN</td>
              <td className="py-2 text-gray-600">Full access within the tenant</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">ADMIN</td>
              <td className="py-2 text-gray-600">Admin-level access</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">MANAGER</td>
              <td className="py-2 text-gray-600">Manager-level access</td>
            </tr>
            <tr>
              <td className="py-2 pr-6 font-mono text-brand-700">SALES_REP</td>
              <td className="py-2 text-gray-600">Standard user access</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {[
              ...
              <tr key={code}>
                <td className="py-2 pr-6 font-mono">{code}</td>
                <td className="py-2 text-gray-600">{desc}</td>
              </tr>
            ))}
          </tbody>
...
function RateLimitsSection() {
  return (
    <div>
      ...
      <p className="text-lg text-gray-600 mb-8">
        ERPnBox enforces rate limits to ensure fair usage and platform stability.
      </p>
      ...
      <div className="overflow-x-auto my-4">
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              <td className="py-2 pr-6">Global (per IP)</td>
              <td className="py-2 pr-6">1,000 requests</td>
              <td className="py-2">15 minutes</td>
            </tr>
            <tr>
              <td className="py-2 pr-6">Per API key</td>
              <td className="py-2 pr-6">Configurable (default: 1,000)</td>
              <td className="py-2">15 minutes</td>
            </tr>
          </tbody>
        </table>
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-700">
        <li>
          <strong>Cache responses</strong> &mdash; Module metadata changes infrequently
        </li>
        <li>
          <strong>Use pagination</strong> &mdash; Fetch in pages, not all at once
        </li>
        <li>
          <strong>Implement backoff</strong> &mdash; On 429 responses, wait before retrying
        </li>
        <li>
          <strong>Monitor usage</strong> &mdash; Track consumption via the usage endpoint
        </li>
      </ul>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-16 flex">
        {/* Sidebar */}
        <aside
          className={`${mobileMenuOpen ? 'block' : 'hidden'} lg:block fixed lg:sticky top-16 left-0 z-40 w-64 h-[calc(100vh-4rem)] bg-gray-50 border-r border-gray-200 overflow-y-auto`}
        >
        ...
        <main className="flex-1 min-w-0 px-6 lg:px-12 py-10 max-w-4xl">
          ...
          <div className="mt-16 pt-8 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-400">
              ERPnBox API v1 &mdash; Need help? Contact{' '}
