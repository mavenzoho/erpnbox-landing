...
const APP_URL = import.meta.env.VITE_APP_URL || 'https://app.erpnbox.com';
...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'hero.badge': {
    en: 'Now with AI-Powered Module Creation',
    ar: 'الآن مع إنشاء الوحدات بالذكاء الاصطناعي',
  },
  'hero.title1': { en: 'Your Business,', ar: 'أعمالك،' },
  'hero.title2': { en: 'Unboxed', ar: 'بلا حدود' },
  'hero.sub': {
    en: 'The modular ERP platform with ready-to-use industry templates. Launch in minutes with AI agents that build your custom modules, workflows, and automations.',
    ar: 'منصة ERP المعيارية مع قوالب جاهزة للاستخدام. انطلق في دقائق مع وكلاء الذكاء الاصطناعي الذين يبنون وحداتك وسير العمل والأتمتة المخصصة.',
  },
  ...
  'hero.proof': {
    ...
    ar: 'لا حاجة لبطاقة ائتمان \u00b7 تجربة مجانية 14 يوم \u00b7 إلغاء في أي وقت',
  },
  'feat.label': { en: 'Everything You Need', ar: 'كل ما تحتاجه' },
  'feat.title': {
    en: 'One platform, unlimited possibilities',
    ar: 'منصة واحدة، إمكانيات غير محدودة',
  },
  'feat.sub': {
    en: 'From lead capture to deal close, from workflow automation to AI insights \u2014 ERPnBox handles it all.',
    ar: 'من التقاط العملاء المحتملين إلى إغلاق الصفقات، ومن أتمتة سير العمل إلى رؤى الذكاء الاصطناعي \u2014 ERPnBox يتولى كل شيء.',
  },
  'feat.0.title': { en: 'Dynamic Modules', ar: 'وحدات ديناميكية' },
  'feat.0.desc': {
    en: 'Create custom modules with any field type. No coding required \u2014 just define your data model and go.',
    ar: 'أنشئ وحدات مخصصة بأي نوع حقل. لا حاجة للبرمجة \u2014 حدد نموذج بياناتك وانطلق.',
  },
  'feat.1.title': { en: 'CRM & Contact Management', ar: 'إدارة علاقات العملاء وجهات الاتصال' },
  'feat.1.desc': {
    en: 'Manage leads, contacts, accounts, and deals through a fully customizable pipeline.',
    ar: 'أدر العملاء المحتملين وجهات الاتصال والحسابات والصفقات من خلال مسار قابل للتخصيص بالكامل.',
  },
  'feat.2.title': { en: 'Workflow Automation', ar: 'أتمتة سير العمل' },
  'feat.2.desc': {
    en: 'Build automated workflows with conditions, field updates, email alerts, webhooks, and assignment rules.',
    ar: 'أنشئ سير عمل آلي مع شروط وتحديثات الحقول وتنبيهات البريد الإلكتروني والويب هوك وقواعد التعيين.',
  },
  'feat.3.title': { en: 'Roles & Profiles', ar: 'الأدوار والملفات الشخصية' },
  'feat.3.desc': {
    en: 'Enterprise-grade RBAC with role hierarchy, field-level permissions, and data sharing rules.',
    ar: 'نظام صلاحيات متقدم مع تسلسل الأدوار وأذونات على مستوى الحقل وقواعد مشاركة البيانات.',
  },
  'feat.4.title': { en: 'KPI Tracking', ar: 'تتبع مؤشرات الأداء' },
  'feat.4.desc': {
    en: 'Define performance indicators and assign them to individuals, roles, or teams with real-time dashboards.',
    ar: 'حدد مؤشرات الأداء وعيّنها للأفراد أو الأدوار أو الفرق مع لوحات معلومات في الوقت الفعلي.',
  },
  'feat.5.title': { en: 'Meeting Scheduler', ar: 'جدولة الاجتماعات' },
  'feat.5.desc': {
    en: 'Intuitive calendar-based meeting creation with drag-and-drop time selection and attendee management.',
    ar: 'إنشاء اجتماعات بتقويم سهل مع اختيار الوقت بالسحب والإفلات وإدارة الحضور.',
  },
  'feat.6.title': { en: 'Email Integration', ar: 'تكامل البريد الإلكتروني' },
  'feat.6.desc': {
    en: 'Send emails directly from records with customizable templates and full activity tracking.',
    ar: 'أرسل رسائل بريد إلكتروني مباشرة من السجلات مع قوالب قابلة للتخصيص وتتبع كامل للنشاط.',
  },
  'feat.7.title': { en: 'Custom Functions', ar: 'الدوال المخصصة' },
  'feat.7.desc': {
    en: 'Write serverless functions in JavaScript that execute on triggers, schedules, or API calls.',
    ar: 'اكتب دوال بدون خادم بلغة JavaScript تنفذ عند المحفزات أو الجداول أو استدعاءات API.',
  },
  'feat.8.title': { en: 'Multi-Tenant SaaS', ar: 'SaaS متعدد المستأجرين' },
  'feat.8.desc': {
    en: 'Built for scale with row-level tenant isolation, per-tenant customization, and platform admin controls.',
    ar: 'مبني للتوسع مع عزل المستأجرين على مستوى الصف وتخصيص لكل مستأجر وأدوات إدارة المنصة.',
  },
  'tmpl.label': { en: 'Ready-to-Use Templates', ar: 'قوالب جاهزة للاستخدام' },
  'tmpl.title': {
    en: 'Launch your CRM in minutes, not months',
    ar: 'أطلق نظام CRM الخاص بك في دقائق، وليس أشهر',
  },
  'tmpl.sub': {
    en: 'Choose an industry template pre-loaded with modules, fields, workflows, and sample data. Customize everything to fit your business perfectly.',
    ar: 'اختر قالب صناعي محمّل مسبقاً بالوحدات والحقول وسير العمل وبيانات عينة. خصص كل شيء ليناسب عملك بشكل مثالي.',
  },
  'tmpl.use': { en: 'Use this template', ar: 'استخدم هذا القالب' },
  'tmpl.more': {
    en: 'More templates added monthly. Or create your own from scratch.',
    ar: 'يتم إضافة المزيد من القوالب شهرياً. أو أنشئ قالبك من الصفر.',
  },
  'tmpl.0.name': { en: 'Real Estate CRM', ar: 'إدارة العقارات' },
  'tmpl.0.desc': {
    en: 'Properties, listings, agents, viewings, commissions, and closing pipelines.',
    ar: 'العقارات والقوائم والوكلاء والمعاينات والعمولات ومسارات الإغلاق.',
  },
  'tmpl.1.name': { en: 'Sales CRM', ar: 'إدارة المبيعات' },
  'tmpl.1.desc': {
    en: 'Full sales pipeline with leads, contacts, accounts, deals, and activities.',
    ar: 'مسار مبيعات كامل مع العملاء المحتملين وجهات الاتصال والحسابات والصفقات والأنشطة.',
  },
  'tmpl.2.name': { en: 'Recruitment', ar: 'التوظيف' },
  'tmpl.2.desc': {
    en: 'Candidates, job openings, interviews, offers, and onboarding tracking.',
    ar: 'المرشحون وفرص العمل والمقابلات والعروض وتتبع التهيئة.',
  },
  'tmpl.3.name': { en: 'Project Management', ar: 'إدارة المشاريع' },
  'tmpl.3.desc': {
    en: 'Projects, tasks, milestones, timesheets, and team collaboration.',
    ar: 'المشاريع والمهام والمراحل وجداول الوقت والتعاون الجماعي.',
  },
  'tmpl.4.name': { en: 'Education', ar: 'التعليم' },
  'tmpl.4.desc': {
    en: 'Students, courses, enrollments, grades, and fee management.',
    ar: 'الطلاب والدورات والتسجيل والدرجات وإدارة الرسوم.',
  },
  'tmpl.5.name': { en: 'Healthcare', ar: 'الرعاية الصحية' },
  'tmpl.5.desc': {
    en: 'Patients, appointments, treatments, prescriptions, and billing.',
    ar: 'المرضى والمواعيد والعلاجات والوصفات والفواتير.',
  },
  'ai.badge': { en: 'Powered by AI', ar: 'مدعوم بالذكاء الاصطناعي' },
  'ai.title': {
    en: 'AI Agents that build your ERP',
    ar: 'وكلاء ذكاء اصطناعي يبنون نظام ERP الخاص بك',
  },
  'ai.sub': {
    en: 'Stop configuring. Start describing. Our AI agents turn your words into fully functional modules, workflows, and automations.',
    ar: 'توقف عن التكوين. ابدأ بالوصف. وكلاء الذكاء الاصطناعي لدينا يحولون كلماتك إلى وحدات وسير عمل وأتمتة كاملة الوظائف.',
  },
  'ai.0.title': { en: 'AI Module Creator', ar: 'منشئ الوحدات بالذكاء الاصطناعي' },
  'ai.0.desc': {
    en: 'Describe your business process in plain English. Our AI agent designs the perfect module with fields, validations, and workflows \u2014 ready in seconds.',
    ar: 'صف عملية عملك بلغة بسيطة. وكيل الذكاء الاصطناعي يصمم الوحدة المثالية بالحقول والتحققات وسير العمل \u2014 جاهزة في ثوانٍ.',
  },
  'ai.1.title': { en: 'Smart Field Suggestions', ar: 'اقتراحات الحقول الذكية' },
  'ai.1.desc': {
    en: 'AI analyzes your industry and suggests optimal field types, picklist values, and validation rules based on best practices.',
    ar: 'الذكاء الاصطناعي يحلل صناعتك ويقترح أنواع الحقول المثلى وقيم القوائم وقواعد التحقق بناءً على أفضل الممارسات.',
  },
  'ai.2.title': { en: 'Workflow Builder Agent', ar: 'وكيل بناء سير العمل' },
  'ai.2.desc': {
    en: 'Tell the AI what should happen when a deal closes or a lead goes cold. It builds the complete automation workflow for you.',
    ar: 'أخبر الذكاء الاصطناعي بما يجب أن يحدث عند إغلاق صفقة أو فقدان عميل محتمل. يبني سير العمل الآلي الكامل لك.',
  },
  'ai.3.title': { en: 'Natural Language Queries', ar: 'استعلامات باللغة الطبيعية' },
  'ai.3.desc': {
    en: 'Ask questions like "Show me all deals over $50K closing this month" and get instant results. No filters to configure.',
    ar: 'اطرح أسئلة مثل "أرني جميع الصفقات التي تزيد عن 50 ألف والتي تُغلق هذا الشهر" واحصل على نتائج فورية. لا حاجة لتكوين فلاتر.',
  },
  'ai.4.title': { en: 'Template Generator', ar: 'مولّد القوالب' },
  'ai.4.desc': {
    en: 'Describe your industry and business model. AI generates a complete template with modules, fields, workflows, and sample data.',
    ar: 'صف صناعتك ونموذج عملك. الذكاء الاصطناعي يولّد قالباً كاملاً بالوحدات والحقول وسير العمل وبيانات العينة.',
  },
  'ai.5.title': { en: 'Predictive Insights', ar: 'رؤى تنبؤية' },
  'ai.5.desc': {
    en: 'AI analyzes your data patterns to predict deal outcomes, suggest best next actions, and identify at-risk accounts.',
    ar: 'الذكاء الاصطناعي يحلل أنماط بياناتك للتنبؤ بنتائج الصفقات واقتراح أفضل الإجراءات التالية وتحديد الحسابات المعرضة للخطر.',
  },
  'ai.try': { en: 'Try it yourself', ar: 'جرّب بنفسك' },
  'ai.prompt': {
    en: '"Create a module for tracking customer support tickets with priority levels, assignee, SLA timer, and auto-escalation workflow"',
    ar: '"أنشئ وحدة لتتبع تذاكر دعم العملاء مع مستويات الأولوية والمكلّف ومؤقت SLA وسير عمل التصعيد التلقائي"',
  },
  'ai.result': {
    en: 'AI generates: 8 fields, 2 workflows, 1 assignment rule \u2014 in 10 seconds',
    ar: 'الذكاء الاصطناعي يولّد: 8 حقول، 2 سير عمل، 1 قاعدة تعيين \u2014 في 10 ثوانٍ',
  },
  ...
  'how.0.desc': {
    en: 'Pick an industry template or start from scratch. Templates come with modules, fields, workflows, and sample data.',
    ar: 'اختر قالب صناعي أو ابدأ من الصفر. القوالب تأتي مع وحدات وحقول وسير عمل وبيانات عينة.',
  },
  'how.1.title': { en: 'Customize with AI', ar: 'خصص بالذكاء الاصطناعي' },
  'how.1.desc': {
    en: 'Describe what you need in plain English. AI agents build custom modules, fields, and automations instantly.',
    ar: 'صف ما تحتاجه بلغة بسيطة. وكلاء الذكاء الاصطناعي يبنون وحدات وحقول وأتمتة مخصصة فوراً.',
  },
  'how.2.title': { en: 'Go Live', ar: 'انطلق' },
  'how.2.desc': {
    en: 'Invite your team, import data, and start working. Your custom ERP is ready on your own domain.',
    ar: 'ادعُ فريقك واستورد البيانات وابدأ العمل. نظام ERP المخصص جاهز على نطاقك الخاص.',
  },
  ...
  'price.sub': {
    ...
    ar: 'ابدأ مجاناً. توسع مع نموك. لا رسوم خفية.',
  },
  'price.starter': { en: 'Starter', ar: 'المبتدئ' },
  'price.starter.desc': {
    en: 'For individuals and small teams getting started.',
    ar: 'للأفراد والفرق الصغيرة في البداية.',
  },
  'price.starter.cta': { en: 'Start Free', ar: 'ابدأ مجاناً' },
  'price.pro': { en: 'Professional', ar: 'الاحترافي' },
  'price.pro.desc': {
    en: 'For growing teams that need full customization.',
    ar: 'للفرق النامية التي تحتاج تخصيصاً كاملاً.',
  },
  'price.pro.cta': { en: 'Start Free Trial', ar: 'ابدأ تجربة مجانية' },
  'price.ent': { en: 'Enterprise', ar: 'المؤسسات' },
  'price.ent.desc': {
    en: 'For organizations with advanced security needs.',
    ar: 'للمؤسسات ذات احتياجات الأمان المتقدمة.',
  },
  ...
  'cta.sub': {
    en: 'Join thousands of businesses running on ERPnBox. Start with a template, customize with AI, and deploy on your domain today.',
    ar: 'انضم إلى آلاف الشركات التي تعمل على ERPnBox. ابدأ بقالب، خصص بالذكاء الاصطناعي، وانشر على نطاقك اليوم.',
  },
  'cta.trial': { en: 'Start Free Trial', ar: 'ابدأ تجربة مجانية' },
  'cta.demo': { en: 'Schedule a Demo', ar: 'احجز عرضاً توضيحياً' },
  'footer.tagline': {
    en: 'The modular ERP platform that grows with your business.',
    ar: 'منصة ERP المعيارية التي تنمو مع عملك.',
  },
...
const FEATURES = [
  {
    ...
    description:
      'Create custom modules with any field type. No coding required — just define your data model and go.',
  },
  {
    icon: IconUsers,
    title: 'CRM & Contact Management',
    description:
      'Manage leads, contacts, accounts, and deals through a fully customizable pipeline.',
  },
  {
    icon: IconCog,
    title: 'Workflow Automation',
    description:
      'Build automated workflows with conditions, field updates, email alerts, webhooks, and assignment rules.',
  },
  {
    icon: IconShield,
    title: 'Roles & Profiles',
    description:
      'Enterprise-grade RBAC with role hierarchy, field-level permissions, and data sharing rules.',
  },
  {
    icon: IconChart,
    title: 'KPI Tracking',
    description:
      'Define performance indicators and assign them to individuals, roles, or teams with real-time dashboards.',
  },
  {
    icon: IconCalendar,
    title: 'Meeting Scheduler',
    description:
      'Intuitive calendar-based meeting creation with drag-and-drop time selection and attendee management.',
  },
  {
    icon: IconMail,
    title: 'Email Integration',
    description:
      'Send emails directly from records with customizable templates and full activity tracking.',
  },
  {
    icon: IconBolt,
    title: 'Custom Functions',
    description:
      'Write serverless functions in JavaScript that execute on triggers, schedules, or API calls.',
  },
  {
    icon: IconGlobe,
    title: 'Multi-Tenant SaaS',
    description:
      'Built for scale with row-level tenant isolation, per-tenant customization, and platform admin controls.',
  },
];
...
const AI_FEATURES = [
  {
    ...
    description:
      'Describe your business process in plain English. Our AI agent designs the perfect module with fields, validations, and workflows — ready in seconds.',
    badge: 'Agent',
  },
  {
    title: 'Smart Field Suggestions',
    description:
      'AI analyzes your industry and suggests optimal field types, picklist values, and validation rules based on best practices.',
    badge: 'Intelligence',
  },
  {
    title: 'Workflow Builder Agent',
    description:
      'Tell the AI what should happen when a deal closes or a lead goes cold. It builds the complete automation workflow for you.',
    badge: 'Agent',
  },
  {
    title: 'Natural Language Queries',
    description:
      'Ask questions like "Show me all deals over $50K closing this month" and get instant results. No filters to configure.',
    badge: 'Intelligence',
  },
  {
    title: 'Template Generator',
    description:
      'Describe your industry and business model. AI generates a complete template with modules, fields, workflows, and sample data.',
    badge: 'Agent',
  },
  {
    title: 'Predictive Insights',
    description:
      'AI analyzes your data patterns to predict deal outcomes, suggest best next actions, and identify at-risk accounts.',
    badge: 'Intelligence',
  },
];
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-3">
          ...
          <div className="pt-3 border-t border-gray-100 space-y-2">
            <a href={`${APP_URL}/login`} className="block text-sm font-medium text-gray-600 py-2">
              {t('nav.signin')}
            </a>
            <a
              href={`${APP_URL}/register`}
              className="block text-center px-4 py-2.5 rounded-lg bg-brand-600 text-white text-sm font-semibold"
            >
              {t('nav.trial')}
            </a>
          </div>
...
function AISection() {
  ...
  return (
    <section
      id="ai"
      className="py-24 bg-gradient-to-b from-brand-950 to-brand-900 relative overflow-hidden"
    >
...
function Pricing() {
  ...
  const plans = [
    {
      nameKey: 'price.starter',
      priceKey: 'price.free',
      periodKey: 'price.forever',
      descKey: 'price.starter.desc',
      ctaKey: 'price.starter.cta',
      highlighted: false,
      featureKeys: [
        'price.f.3users',
        'price.f.5mod',
    ...
    },
    {
      nameKey: 'price.pro',
      priceKey: '$15',
      periodKey: 'price.peruser',
      descKey: 'price.pro.desc',
      ctaKey: 'price.pro.cta',
      highlighted: true,
      featureKeys: [
        'price.f.unlmod',
        'price.f.unlrec',
    ...
    {
      nameKey: 'price.ent',
      priceKey: 'price.custom',
      periodKey: '',
      descKey: 'price.ent.desc',
      ctaKey: 'price.ent.cta',
      highlighted: false,
      featureKeys: [
        'price.f.everything',
        'price.f.multitenant',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.nameKey}
                className={`rounded-2xl p-8 ${plan.highlighted ? 'bg-brand-600 text-white shadow-xl shadow-brand-600/25 ring-4 ring-brand-600/20 scale-105' : 'bg-white border border-gray-200 shadow-sm'}`}
              >
                <h3
                  className={`text-lg font-semibold ${plan.highlighted ? 'text-brand-100' : 'text-gray-900'}`}
                >
                  {t(plan.nameKey)}
                </h3>
                ...
                <ul className="mt-6 space-y-3">
                  {plan.featureKeys.map((fk) => (
                    <li key={fk} className="flex items-start gap-2">
                      <IconCheck
                        className={`w-5 h-5 mt-0.5 flex-shrink-0 ${plan.highlighted ? 'text-brand-200' : 'text-brand-500'}`}
                      />
                      <span
                        className={`text-sm ${plan.highlighted ? 'text-brand-100' : 'text-gray-600'}`}
                      >
                        {t(fk)}
                      </span>
                    </li>
                ...
                <a
                  href={`${APP_URL}/register`}
                  className={`mt-8 block text-center py-3 px-6 rounded-xl font-semibold text-sm transition-all ${plan.highlighted ? 'bg-white text-brand-600 hover:bg-brand-50 shadow-lg' : 'bg-brand-600 text-white hover:bg-brand-700'}`}
                >
                  {t(plan.ctaKey)}
                </a>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="/features/crm" className="text-sm hover:text-white transition-colors">
                  CRM
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/features/hrms" className="text-sm hover:text-white transition-colors">
                  HRMS
                </a>
              </li>
              <li>
                <a href="/features/security" className="text-sm hover:text-white transition-colors">
                  Security
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="/developers" className="text-sm hover:text-white transition-colors">
                  API Docs
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="/data-deletion" className="text-sm hover:text-white transition-colors">
                  Data Deletion
                </a>
              </li>
              <li>
