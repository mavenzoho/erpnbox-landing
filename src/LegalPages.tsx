  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <a
          href="/"
          className="inline-flex items-center gap-1.5 text-sm text-indigo-600 hover:text-indigo-700 mb-8"
        >
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Data you enter into ERPnBox modules (contacts, leads, deals, activities, etc.) is stored
              securely within your tenant-isolated environment. This data belongs to you and is
            ...
            <p className="text-gray-700 leading-relaxed mt-2">
              We access this data only through permissions you explicitly grant via the Facebook OAuth
              authorization flow. We do not access any data beyond what is required for the lead
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              We do <strong>not</strong> sell, rent, or share your personal data or CRM data with third
              parties for their marketing purposes. We may share data only in the following
              circumstances:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
              <li>
                <strong>Service Providers:</strong> With trusted third-party providers who help us
                operate our platform (hosting, email delivery, analytics), under strict data processing
                agreements.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <li>
                Data obtained from Meta is used solely to sync leads into your CRM and is not used for
                any other purpose
              </li>
              <li>
              ...
              <li>
                You can disconnect your Facebook Pages at any time from Settings &gt; SocialSync, which
                revokes our access
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              services. CRM data is retained within your tenant environment until you delete it or close
              your account. Sync logs from SocialSync are retained for audit purposes and can be viewed
              in the SocialSync Dashboard. Upon account termination, all tenant data is permanently
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <li>
                ...
                <a href="mailto:support@erpnbox.com" className="text-indigo-600 hover:underline">
                  support@erpnbox.com
                </a>{' '}
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ERPnBox is a business application not intended for use by individuals under the age of 16.
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Your continued use of ERPnBox after changes constitutes acceptance of the updated policy.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-none pl-0 text-gray-700 space-y-1 mt-2">
              ...
              <li>
                ...
                <a href="https://erpnbox.com" className="text-indigo-600 hover:underline">
                  erpnbox.com
                </a>
              </li>
            </ul>
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              "us"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, you
              may not use the Platform. These Terms apply to all users, including administrators, team
              members, and any person accessing the Platform on behalf of an organization.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ERPnBox is a cloud-based Customer Relationship Management (CRM) and Enterprise Resource
              Planning (ERP) platform that provides tools for managing contacts, leads, deals,
              activities, workflows, reporting, and third-party integrations including social media lead
              synchronization (SocialSync). The Platform is provided as a Software-as-a-Service (SaaS)
              solution.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              You retain full ownership of all data you enter into the Platform ("Your Data"), including
              CRM records, contacts, leads, documents, and any data synced from third-party services. We
              do not claim any ownership rights over Your Data.
            </p>

            <h3 className="text-lg font-medium text-gray-800 mt-4 mb-2">5.2 License to Us</h3>
            <p className="text-gray-700 leading-relaxed">
              You grant us a limited, non-exclusive license to process, store, and transmit Your Data
              solely for the purpose of providing and improving the Platform services. This license ends
              when you delete Your Data or terminate your account.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed">
              While we maintain regular backups of the Platform, you are responsible for maintaining your
              own backups of critical data. You may export Your Data at any time through the Platform's
              export features or API.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              The Platform offers integrations with third-party services, including but not limited to
              Meta (Facebook/Instagram) for lead synchronization. When you enable these integrations:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
              <li>
              ...
              <li>
                You are responsible for complying with the third party's terms of service and policies
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              The Platform, including its source code, design, features, documentation, and branding, is
              the intellectual property of ERPnBox and is protected by copyright, trademark, and other
              intellectual property laws. These Terms do not grant you any rights to use our trademarks,
              logos, or brand assets without prior written consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              or error-free service. We may perform scheduled maintenance with reasonable advance notice.
              We are not liable for any downtime, data loss, or service interruptions caused by factors
              beyond our reasonable control, including third-party service outages, network failures, or
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              of profits, data, business opportunities, or goodwill, arising from your use of or
              inability to use the Platform. Our total liability for any claim arising from these Terms
              or your use of the Platform shall not exceed the amount you paid to us in the twelve (12)
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              that the Platform will meet your specific requirements or that it will be free of errors or
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>
                ...
                behavior, or fail to pay applicable fees.
              </li>
              <li>
              ...
              <li>
                Sections regarding intellectual property, limitation of liability, and dispute resolution
                survive termination.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Your continued use of the Platform after changes constitutes acceptance of the revised
              Terms. If you do not agree with the changes, you must stop using the Platform and
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              jurisdiction in which ERPnBox operates, without regard to conflict of law principles. Any
              disputes arising from these Terms shall be resolved through good-faith negotiation, and if
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ERPnBox allows you to delete data associated with your Facebook connection at any time.
              When you disconnect your Facebook Page from ERPnBox, we remove all associated connection
              data, access tokens, and sync configurations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              To request complete deletion of all your data from ERPnBox, including your account, CRM
              records, and all associated data, please contact us:
            </p>
            <ul className="list-none pl-0 text-gray-700 space-y-1 mt-2">
              <li>
                <strong>Email:</strong>{' '}
            ...
            <p className="text-gray-700 leading-relaxed mt-2">
              We will process your deletion request within 30 days and send a confirmation email upon
              completion.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-2">
              All data is stored in your isolated tenant environment and is not shared with other users
              or third parties.
            </p>
          </section>
        </div>
